        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <img class="img-responsive" src="Resources/dr_kano.jpg" alt="">
                    ...
                    <div class="caption">
                        ...
                        <p>Judo is one of the most popular martial arts in the world and has practitioners on all continents.  There are two 
                            main principles that Dr. Kano had in mind when developing judo: "maximum efficiency with minimal effort" and "mutual 
                            benefit and welfare".  Kano wanted judo to be practiced so that using your opponent's force against them was the main focus, 
                            not simply overpowering them.  He believed tha perfect timing and technique could overcome any strength deficit.  He also believed 
                            that judo was something that could only effectively practiced with a partner and that the ultimate goal of practice was to get 
                            better together.  Kano believed in these principles not only in the context of judo, but also as the foundation of a way of life.
                        </p>
            ...
            <div class="col-md-4 text-center">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <h3>
                            <small>Judo Fun Facts</small>
                        </h3>

                        <ul>
                            <li>There are currently 67 throws accepted by the Kodokan (with hundreds of variations)</li>
                            <li>Sambo and Brazilian Jiu-Jitsu are both derived from judo</li>
                            <li>The first judo dojo, the Kodokan, was created in 1882</li>
                            <li>The country with the largest number of judoka is France</li>
                            <li>Originally, judo competitions were open weight</li>
                            <li>Female divisions were added to the Olympic games in 1992</li>
                        </ul>
